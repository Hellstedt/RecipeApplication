...
{
    /// <inheritdoc />
    public partial class RecipeFunctionalityTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DietaryInformation = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Source = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Raiting = table.Column<decimal>(type: "decimal(2,1)", nullable: true),
